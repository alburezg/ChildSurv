...
<!---
Improve Intro: ¿Why is important study survival descendants from mother perspective?¿How impacts mothers health/welfare/experience?
-->

The objective of this work is to give a formal approach to deomgraphy of surviving childs from mother perspective, looking for relations to characterize this situation: the timing of descedent mortality (mean age at the event and time spent in that state) and the effect of mortality change in the final descendants quantity. Numerical applications of the expressions will be done for Latinoamerican countries during the second half of XX Century. Details on data handling and smooth procedures are exposed in [data section](#Data_appendix) in the Appendix.
